...
export default function PrintDesignSection() {
    ...
    >
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center text-center pointer-events-none z-10">
        ...
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none select-none opacity-[0.03] overflow-hidden">
          <h2
            className="text-[16vw] font-poppins font-black tracking-tighter text-white uppercase whitespace-nowrap scale-y-125"
            style={{
        ...
        <h2 className="text-[8vw] md:text-[6.5vw] font-poppins font-black tracking-tighter leading-none uppercase select-none flex flex-col items-center justify-center">
          <span className="text-white drop-shadow-[0_0_30px_rgba(255,255,255,0.03)]">PRINT</span>
        ...
        <div className="flex flex-col items-center gap-2 mt-12 font-sans font-semibold">
          <p className="text-[9px] md:text-[10px] tracking-[0.25em] text-white/50 uppercase flex items-center gap-2">
            <span className="text-[#ff5a00] text-[6px]">♦</span> BRANDS ARE MORE THAN JUST A LOOK <span className="text-[#ff5a00] text-[6px]">♦</span>
          </p>
      ...
      {/* Bottom glow anchor */}
      <div className="absolute bottom-20 left-1/2 -translate-x-1/2 w-[200px] h-[20px] bg-[#ff5a00]/30 blur-[20px] rounded-full pointer-events-none z-10" />
